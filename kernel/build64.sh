#! /bin/bash
# compile stub
gcc stub/x64/uefi/uefi.c -c -fno-stack-protector -fpic -fshort-wchar -mno-red-zone -I /usr/include/efi -I /usr/include/efi/x86_64 -DEFI_FUNCTION_WRAPPER -o uefi.o
